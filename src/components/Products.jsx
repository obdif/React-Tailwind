    ...
    return (
        <div >
            <div className="px-4 lg:px-14 max-w-screen-2xl mx-auto my-8" id='product'>
                <div className="md:w-11/12 mx-auto flex flex-col md:flex-row justify-between items-center gap-8" data-aos="fade-down">
                    <div className='w-90'>
                        <img src={Website} alt="" />
                    </div>
                ...
                {/* ================ COMPANY STATS ============= */}
                <div className="px-4 lg:px-14 max-w-screen-2xl mx-auto bg-neutralSilver rounded  py-16" data-aos="zoom-in">
